...
// TLS cert/key paths loaded from environment (TLS_CERT_PATH, TLS_KEY_PATH) at server start
...
MongoClient.connect(db, (err, db) => {
    ...
    */
    ...
    // Use HTTPS when TLS cert/key paths are configured, fall back to HTTP for development
