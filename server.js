...
MongoClient.connect(db, (err, db) => {
    ...
    */
    ...
    // Use HTTPS when TLS certificate and key paths are provided via environment variables
    ...
    if (tlsKeyPath && tlsCertPath) {
        ...
        // Fallback to HTTP when TLS certificates are not configured (local development)
