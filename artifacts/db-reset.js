...
// Seed passwords loaded from environment variables.
// To override defaults, set: ADMIN_PASSWORD, USER1_PASSWORD, USER2_PASSWORD
const USERS_TO_INSERT = [
    {
        ...
        "firstName": "Node Goat",
        "lastName": "Admin",
        "password": process.env.ADMIN_PASSWORD || "Admin_123",
        "isAdmin": true
    }, {
        "_id": 2,
        "userName": "user1",
        ...
        "password": process.env.USER1_PASSWORD || "User1_123"
    }, {
        "_id": 3,
        "userName": "user2",
        "firstName": "Will",
        ...
        "password": process.env.USER2_PASSWORD || "User2_123"
    }];
