...
const USERS_TO_INSERT = [
    {
        ...
        "lastName": "Admin",
        "password": "Admin_123",
        //"password" : "$2a$10$8Zo/1e8KM8QzqOKqbDlYlONBOzukWXrM.IiyzqHRYDXqwB3gzDsba", // Admin_123 - demo bcrypt hash for OWASP training app
        "isAdmin": true
    }, {
        "_id": 2,
        "userName": "user1",
        ...
        "password": "User1_123"
        // "password" : "$2a$10$RNFhiNmt2TTpVO9cqZElb.LQM9e1mzDoggEHufLjAnAKImc6FNE86",// User1_123 - demo bcrypt hash for OWASP training app
    }, {
        "_id": 3,
        "userName": "user2",
        "firstName": "Will",
        ...
        "password": "User2_123"
        //"password" : "$2a$10$Tlx2cNv15M0Aia7wyItjsepeA8Y6PyBYaNdQqvpxkIUlcONf1ZHyq", // User2_123 - demo bcrypt hash for OWASP training app
    }];
